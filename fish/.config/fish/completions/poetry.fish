function __fish_poetry_9afe8c864ea62e1e_complete_no_subcommand
...
# global options
complete -c poetry -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -l ansi -d 'Force ANSI output'
complete -c poetry -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -l help -d 'Display this help message'
complete -c poetry -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -l no-ansi -d 'Disable ANSI output'
complete -c poetry -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -l no-interaction -d 'Do not ask any interactive question'
complete -c poetry -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -l quiet -d 'Do not output any message'
complete -c poetry -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -l verbose -d 'Increase the verbosity of messages: 1 for normal output, 2 for more verbose output and 3 for debug'
complete -c poetry -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -l version -d 'Display this application version'

# commands
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a about -d 'Short information about Poetry.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a add -d 'Add a new dependency to pyproject.toml.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a build -d 'Builds a package, as a tarball and a wheel by default.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a cache:clear -d 'Clears poetry\'s cache.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a check -d 'Checks the validity of the pyproject.toml file.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a config -d 'Sets/Gets config options.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a debug:info -d 'Shows debug information.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a debug:resolve -d 'Debugs dependency resolution.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a develop -d 'Installs the current project in development mode. (Deprecated)'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a help -d 'Displays help for a command'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a init -d 'Creates a basic pyproject.toml file in the current directory.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a install -d 'Installs the project dependencies.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a list -d 'Lists commands'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a lock -d 'Locks the project dependencies.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a new -d 'Creates a new Python project at <path>'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a publish -d 'Publishes a package to a remote repository.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a remove -d 'Removes a package from the project dependencies.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a run -d 'Runs a command in the appropriate environment.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a script -d 'Executes a script defined in pyproject.toml. (Deprecated)'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a search -d 'Searches for packages on remote repositories.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a self:update -d 'Updates poetry to the latest version.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a shell -d 'Spawns a shell within the virtual environment.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a show -d 'Shows information about packages.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a update -d 'Update dependencies as according to the pyproject.toml file.'
complete -c poetry -f -n '__fish_poetry_9afe8c864ea62e1e_complete_no_subcommand' -a version -d 'Bumps the version of the project.'
