...
function __orbctl_prepare_completions
    ...
    set -l results (__orbctl_perform_completion)
    __orbctl_debug "Completion results: $results"
    ...
    set --global __orbctl_comp_results $results[1..-2]
...
complete -c orbctl -n '__orbctl_prepare_completions' -f -a '$__orbctl_comp_results'
