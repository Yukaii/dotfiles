function spm_app_selector -a command
    ...
    if set -q _flag_help
        ...
        echo ""
        echo "Examples:"
        echo "  spm_app_selector --appName=my_app -- [COMMAND]"
        echo "  spm_app_selector --config=ecosystem.config.js -- [COMMAND]"
        echo "  spm_app_selector --appName=my_app --config=ecosystem.config.js -- [COMMAND]"
        return
    end
