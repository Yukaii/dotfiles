# Kanagawa Alabaster theme for Kakoune
# Kanagawa color palette with Alabaster highlighting principles
# Based on: https://tonsky.me/blog/syntax-highlighting/
# Minimal highlighting focused on: strings, constants, comments, and top-level definitions

# Color palette (Kanagawa colors)
...
# Purple = all statically known constants (numbers, symbols, booleans like true/false/null)
# White = control keywords (if/else/function/class/return)
...
set-face global builtin "%opt{purple}"
...
# Purple = statically known constants (numbers, booleans, null, symbols)
# White = control keywords (if/else/for/function/class/return)
