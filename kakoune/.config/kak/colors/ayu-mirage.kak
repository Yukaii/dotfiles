...
set-face global ts_conceal                      "%opt{purple}+i"
set-face global ts_constant                     "%opt{light_orange}"
...
set-face global ts_diff_delta_moved             "%opt{purple}"
...
set-face global ts_keyword_control_conditional  "%opt{purple}+i"
...
set-face global ts_markup_bold                  "%opt{light_orange}+b"
...
set-face global ts_markup_heading_6             "%opt{blue_green}"
set-face global ts_markup_heading_marker        "%opt{light_orange}+b"
...
set-face global ts_markup_list_unchecked        "%opt{blue_green}"
set-face global ts_markup_list_unnumbered       "%opt{purple}"
set-face global ts_markup_link_label            "%opt{blue}"
set-face global ts_markup_link_url              "%opt{blue_green}+u"
set-face global ts_markup_link_uri              "%opt{blue_green}+u"
...
set-face global ts_property                     "%opt{blue}"
...
set-face global ts_spell                        "%opt{purple}"
...
set-face global ts_tag                          "%opt{purple}"
set-face global ts_tag_error                    "%opt{red}"
set-face global ts_text                         "%opt{white}"
set-face global ts_text_title                   "%opt{purple}"
...
set-face global ts_variable_other_member        "%opt{blue_green}"
set-face global ts_variable_parameter           "%opt{pink}+i"
